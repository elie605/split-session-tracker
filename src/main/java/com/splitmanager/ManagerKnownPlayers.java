...
public class ManagerKnownPlayers {
    ...
    public void loadFromConfig(){
        ...
        if (altsJson != null && !altsJson.isEmpty()) {
            try {
                ...
                if (m != null) altMainMapping.putAll(m);
    ...
    public boolean canLinkAltToMain(String alt, String main) {
        ...
        if (altMainMapping.containsKey(m)) return false;
        // alt cannot already have a different main
        if (altMainMapping.containsKey(a) && !altMainMapping.get(a).equalsIgnoreCase(m)) return false;
    ...
    public boolean unlinkAlt(String alt) {
        ...
        String a = alt.trim();
        if (!altMainMapping.containsKey(a)) return false;
    ...
    public List<String> getAltsOf(String main) {
        if (main == null || main.isBlank()) return List.of();
        String m = main.trim();
